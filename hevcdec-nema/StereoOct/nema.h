...
public:
  ...
  void exoradd(unsigned int* exoradd, unsigned int  *lct, unsigned int  *rct, int row, int column, int drange);
  void shdy(unsigned int* exoradd, unsigned int* HammDistY, int row, int column,int drange);
  void shd(unsigned int* HammDistY, unsigned int* hdis, unsigned int *result, int row, int column,int drange);
